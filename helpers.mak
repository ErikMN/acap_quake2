...
# Verify that target device settings have been loaded before running target-side helpers:
.PHONY: checktarget
checktarget:
ifndef TARGET_IP
...
# Verify that sshpass is installed before using SSH-based deployment helpers:
.PHONY: checksshpass
checksshpass:
